...
# To play the game, simply run the script in a Python environment and follow the prompts. The game board will be printed to the console, and you will be prompted to enter the row and column of the piece you want to move, and then the row and column of the square you want to move it to.
